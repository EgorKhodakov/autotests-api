...
from clients.exercises.exercises_schema import GetExercisesApiSchema, CreateExerciseApiSchema, UpdateExerciseApiSchema, \
    GetExerciseResponseSchema, GetExercisesResponseSchema, UpdateExercisesResponseSchema
...
class ExercisesClient(ApiClient):
    ...
    def get_exercises_api(self, query:GetExercisesApiSchema) -> Response:
        """
    ...
    def create_exercise_api(self, request:CreateExerciseApiSchema ) -> Response:
        """
    ...
    def update_exercise_api(self, exercise_id:str, request:UpdateExerciseApiSchema ) -> Response:
        """
    ...
    def get_exercises(self, query:GetExercisesApiSchema) -> GetExercisesResponseSchema:
        """
    ...
    def create_exercise(self, request:CreateExerciseApiSchema ) -> GetExerciseResponseSchema:
        """
        Метод для создания упражнения
        :param request: title, courseId, maxScore, minScore, orderIndex, description, estimatedTime
        :return: ответ в формате json
    ...
    def update_exercise(self, exercise_id:str, request:UpdateExerciseApiSchema ) -> UpdateExercisesResponseSchema:
        """
