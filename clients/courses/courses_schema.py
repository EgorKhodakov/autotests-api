...
class CreateCourseRequestSchema(BaseModel):
    ...
    description: str = Field(default_factory=fake.sentence) # Изначально было fake.text
...
class UpdateCoursesRequestSchema(BaseModel):
    ...
    description: str | None = Field(default_factory=fake.sentence) # Изначально было fake.text
