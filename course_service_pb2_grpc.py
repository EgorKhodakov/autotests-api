...
class CourseServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.CourseService = channel.unary_unary(
                '/courceservice.CourseService/CourseService',
...
def add_CourseServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'CourseService': grpc.unary_unary_rpc_method_handler(
                    servicer.CourseService,
